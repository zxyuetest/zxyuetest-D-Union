...
import { Wallet, CalendarDays, MessageSquarePlus, HeartHandshake, Award, Home as HomeIcon, Compass, User, Bell, ChevronRight, CreditCard, Receipt, Smile, Scale, Megaphone, FileCheck, LogOut, X, ChevronLeft, ClipboardList } from 'lucide-react';
